...
- **Sterling, T., Anderson, M., Brodowicz, M. *High Performance Computing: Modern Systems and Practices*. Morgan Kaufmann, 2017.** — HPCの包括的な教科書。並列計算モデル、分散ファイルシステム、ジョブスケジューリングの理論的背景を体系的に学べる。
