...
> **この章の前提知識**: `pip install パッケージ名` をターミナルで実行したことがあること。不安な場合は [Python公式チュートリアル §12 仮想環境とパッケージ](https://docs.python.org/ja/3/tutorial/venv.html) を先に読むとよい。
...
> <a id="column-ch06-01"></a> **🧬 コラム: Biocondaでのツールセットアップ**
>
...
> <a id="column-ch06-02"></a> **🤖 コラム: 機械学習環境の構築**
>
