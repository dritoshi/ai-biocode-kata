...
- **Shanahan, M. et al. "Role play with large language models". *Nature*, 623, 493–498, 2023.** — LLMの出力を「ロールプレイ」として理解する理論的枠組みを提示した論文。エージェントへの指示（プロンプト）が文脈によって結果を大きく変える理由を、技術的に理解したい読者に推奨する。
