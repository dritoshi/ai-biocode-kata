...
- **Li, H. "A survey of sequence alignment algorithms for next-generation sequencing". *Briefings in Bioinformatics*, 11(5), 473–483, 2010.** https://doi.org/10.1093/bib/bbq015 — SAM/BAM/CRAMフォーマットが生まれた背景と、次世代シーケンサーデータの取り扱いに関するレビュー。本章で紹介したバイオフォーマットの「なぜこの設計なのか」を理解するのに役立つ。
