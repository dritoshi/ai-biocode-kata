...
- **Li, H. "A survey of sequence alignment algorithms for next-generation sequencing". *Briefings in Bioinformatics*, 11(5), 473–483, 2010.** https://doi.org/10.1093/bib/bbq015 — 次世代シーケンサ時代のアラインメント手法を概観したレビュー。SAM/BAMを含む周辺技術がどのような問題意識のもとで整備されたかを理解する助けになる。
