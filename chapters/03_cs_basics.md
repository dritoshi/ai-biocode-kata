...
> 「そうだな……わたしは『結果』だけを求めてはいない。……大切なのは『真実に向かおうとする意志』だと思っている。」
> — アバッキオの先輩警官, 荒木飛呂彦『ジョジョの奇妙な冒険』第5部 黄金の風, 第59巻 (集英社)

> **この章の前提知識**: Pythonのリスト・辞書・集合を使ったことがあること。不安な場合は [Python公式チュートリアル §5 データ構造](https://docs.python.org/ja/3/tutorial/datastructures.html) を先に読むとよい。
...
> <a id="column-ch03-01"></a> 🧬 **コラム: バイオインフォマティクスで出会うデータ構造の使いどころ**
>
...
> <a id="column-ch03-02"></a> **🧬 コラム: バイオインフォマティクスで出会うアルゴリズムの計算量**
>
...
> <a id="column-ch03-03"></a> **🧬 コラム: バイオインフォで踏む浮動小数点の罠**
>
...
> <a id="column-ch03-04"></a> **🧬 コラム: バイオインフォでの乱数再現性**
>
...
> <a id="column-ch03-05"></a> **コラム: なぜ42なのか**
>
...
> <a id="column-ch03-06"></a> **🧬 コラム: inode枯渇 — ディスク容量はあるのにファイルが作れない**
>
