...
- **Erlich, Y., Narayanan, A. "Routes for breaching and protecting genetic privacy". *Nature Reviews Genetics*, 15(6), 409–421, 2014.** — ゲノムプライバシーの脅威と保護手法を体系的にレビューした論文。本章で扱ったゲノムデータの匿名化の限界を深く理解できる。
...
- **文部科学省・厚生労働省・経済産業省. "人を対象とする生命科学・医学系研究に関する倫理指針".** — 日本国内でヒト由来データを扱う研究の基本的な倫理指針。ゲノムデータの取り扱いに関する規制の枠組みを理解するための必読資料。
