...
from scripts.ch21.module_demo import (
    check_shared_libs,
    find_site_packages,
    show_sys_path,
)
from scripts.ch21.mylib import gc_content, reverse_complement, validate_sequence
from scripts.ch21.mylib.core import gc_content as gc_content_direct
from scripts.ch21.mylib.utils import validate_sequence as validate_direct
