...
[![GitHub Release](https://img.shields.io/github/v/release/dritoshi/ai-biocode-kata?include_prereleases)](https://github.com/dritoshi/ai-biocode-kata/releases)
...
各章の文字数・読了時間は [docs/chapter_stats.md](docs/chapter_stats.md) を参照（本文と付録は約40万文字、推定読了時間は初心者約45時間・中級者約25時間）。
...
#### [本書の利用について（免責事項）](chapters/notice.md)

情報の鮮度 / モデルの変動 / プライバシー設定 / 制限付きデータの扱い / 責任の範囲
