...
- 生成日: 2026-07-28
- 対象コミット: `a70a319b57ab78d8762c01fbb2f51b0679542b49`
...
E1解消バッチ5時点で、基準45件の定義単位関係は56件である。
...
| ch21 | 14 | 5 | 1 | 2 | 2 | 0 | 0 | 0 | 9 |
| **合計** | **529** | **134** | **55** | **37** | **42** | **0** | **0** | **0** | **395** |
...
| `B-21-004` | `scripts/ch21/format_question.py`、`scripts/ch21/format_question.py` |
| `B-21-012` | `scripts/ch21/progress_report.py`、`scripts/ch21/progress_report.py` |
