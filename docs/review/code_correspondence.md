...
- 生成日: 2026-07-27
- 対象コミット: `cbe3396787653a4977bcde50466b103205d3e8a0`
...
配置が必要なブロックは134件である。E5は4件であり、具体的な解消順序はE5解消計画に記録した。

`scripts/ch*` 側は全160ファイルで、本文コードと直接対応94件、本文から参照のみ35件、本文コードとの対応なし31件である。
...
| **合計** | **529** | **134** | **36** | **38** | **19** | **37** | **0** | **4** | **395** |
