...
- 生成日: 2026-07-26
- 対象コミット: `c2c2e454f8855a2982cddc14ade95556812e4a91`
...
| E5 | 10 | 配置が必要だが対応実体がない |
| EN | 395 | 規約上、対応実体は不要 |
| **合計** | **529** | 全本文ブロック |

配置が必要なブロックは134件である。E5は10件であり、具体的な解消順序はE5解消計画に記録した。

`scripts/ch*` 側は全142ファイルで、本文コードと直接対応88件、本文から参照のみ25件、本文コードとの対応なし29件である。
...
| **合計** | **529** | **134** | **30** | **38** | **19** | **37** | **0** | **10** | **395** |
